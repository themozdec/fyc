...
<html lang="en">
<head>
    @include('manager.layouts.shared.title-meta', ['title' => "Iniciar Sesión"])
                ...
                <div class="card bg-pattern">
                    <div class="card-body p-4">
                        <div class="text-center w-75 m-auto">
                            ...
                            <p class="text-muted mb-4 mt-3">Primero necesitas verificar tu número de teléfono</p>
                        </div>
                        ...
                        <div class="form-group mb-0 text-center mt-2">
                            <button class="btn btn-primary btn-block" type="button" id="btnSendOTP"> Enviar código</button>
                        </div>
                ...
                <div class="card bg-pattern">
                    <div class="card-body p-4">
                        ...
                        <div class="form-group mb-0 text-center">
                            <button class="btn btn-primary btn-block" type="button" id="btnConfirmOTP"> Confirmar código
                            </button>
                        </div>
