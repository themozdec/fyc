...
<html lang="en">
<head>
    @include('user.layouts.shared.title-meta', ['title' => "Iniciar Sesión"])
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-pattern">
                    <div class="card-body p-4">
                        <div class="text-center w-75 m-auto">
                            <span class="logo">
                                                <span class="logo-lg-text-dark"
                                                      style="letter-spacing: 1px">{{env('APP_NAME')}}</span>
                            </span>
                            <p class="text-muted mb-4 mt-3">Introduzca su dirección de correo electrónico y contraseña para acceder al panel de usuario.</p>
                        </div>
                        ...
                        <form action="{{route('user.login')}}" method="POST" novalidate>
                            ...
                            <div class="form-group mb-3">
                                <a href="{{route('user.password.request')}}" class="text-muted float-right"><small>Olvidaste tu contraseña?</small></a>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        <p><a href="{{route('user.password.request')}}" class="text-white-50 ml-1">¿Olvidaste tu contraseña?</a></p>
