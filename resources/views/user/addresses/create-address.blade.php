@extends('user.layouts.app', ['title' => 'Agregar Dirección'])
        ...
        <div class="row">
            ...
            <div class="col-lg-5 mt-2">
                ...
                <form action="{{route('user.addresses.store')}}" method="POST">
                    @csrf
                    <button type="button" id="useMyLocationBtn" class="btn btn-primary">Usar Mi Ubicación</button>
                    ...
                    <div class="form-group row">
                        <label for="pincode" class="col-sm-2 col-form-label">{{--__('user.pincode')--}}Código Postal</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control  @if($errors->has('pincode')) is-invalid @endif "
                                   id="pincode"
                                   placeholder="{{--__('user.pincode')--}}Codigo Postal" name="pincode" required>
    ...
    <script>
        ...
        function setLocationToMap(latitude, longitude, byLocation = false) {
            ...
            if (byLocation)
                ...
                infoWindow.setContent("Tú seleccionaste aquí");
            infoWindow.open(map);
