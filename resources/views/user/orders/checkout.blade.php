                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="text-sm-right mt-2 mt-sm-0">
                                            ...
                                            <a id="placeOrderBtn" class="btn btn-success" href="#"> <i class="mdi mdi-shopping-outline mr-1"></i> {{__('user.place_order')}}</a>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
                            </div>
...
@section('script')
    ...
    <script>
        ...
        placeOrderBtn.addEventListener('click', function () {
            ...
            var envio = $("#homeDeliveryRadio").is(":checked");
            var direccion = $("#address-radio-0").is(":checked");
            var mpago = $("#stripePaymentRadio").is(":checked");
            ...
            //form.action = form.action.replace(':id', total);
            form.method = 'get';
