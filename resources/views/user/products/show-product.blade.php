                        ...
                        <div class="col-lg-8">
                            <div class="pl-xl-3 mt-3 mt-xl-0">
                                ...
                                @if($product->offer>0)
                                    ...
                                    <h4>Precio : <span class="text-muted mr-2"><del>{{\App\Helpers\AppSetting::$currencySign}}<span id="price-text"></span> </del></span>
                                        <b>{{\App\Helpers\AppSetting::$currencySign}}<span id="discounted-price-text"></span></b></h4>
                                @else
                                    <h4>Precio : <span class="mr-2">{{\App\Helpers\AppSetting::$currencySign}}<span id="price-text"></span></span>
                                    </h4>
                                @endif
                                ...
                                <form action="{{route('user.carts.store')}}" method="post" class="form mb-3 mt-3">
                                    @csrf
                                    <label class="my-1 mr-2" for="quantityinput">Productos</label>
                                    <div class="mt-2">
                                    @foreach($product->productItems as $productItem)
                                        <div class="radio  radio-primary  mb-2 d-flex">
                                            <input type="radio" name="product_item_id" id="product-item-radio-{{$productItem->id}}"
                                                   class="mt-2 align-self-center product_item_id"
