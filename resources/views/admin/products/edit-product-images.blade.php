@extends('admin.layouts.app', ['title' => 'Nuevo Producto'])
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('admin.product-images.store',['id'=>$productId])}}" method="post" class="dropzone" id="myAwesomeDropzone">
                                ...
                                <div class="dz-message needsclick">
                                    ...
                                    <h3>Suelte los archivos aquí o haga clic para elegir una imagen.</h3>
                                </div>
                            </form>
             ...
             <form action="{{route('admin.products.index')}}" method="get" class="dropzone" id="myAwesomeDropzone">
                                @csrf
            <div class="mt-12">
                            <button type="submit" id="finish"
                                    class="btn w-sm btn-primary waves-effect waves-light">{{__('manager.ready')}}</button>
                        </div></form>
            <!-- end row -->
