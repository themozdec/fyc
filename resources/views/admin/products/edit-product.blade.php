@extends('admin.layouts.app', ['title' => 'Editar Producto'])
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card-box">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea rows="11" id="summernote" name="description"
                ...
                <div class="col-12">
                    <div class="text-right mb-3">
                        ...
                        <a class="btn w-sm btn-light waves-effect" href="{{route('admin.products.index')}}">{{__('admin.cancel')}}</a>
    ...
    <script>
        ...
        class Item {
            ...
            createViewFromData(id,features, price, revenue, quantity) {
                ...
                const formGroupLabelQty = document.createElement('label');
                formGroupLabelQty.innerHTML = "{{--__('manager.revenue_as_per_single_item')--}}{{__('manager.quantity')}}";
                formGroupLabelQty.for = "quantity";
