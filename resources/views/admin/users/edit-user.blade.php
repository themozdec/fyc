@extends('admin.layouts.app', ['title' => 'Editar usuario'])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">{{--__('admin.edit_user')--}}Editar usuario</h4>
                </div>
            </div>
        </div>
                        ...
                        >
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="name" name="name"
                                       ...
                                       placeholder="e.g : Apple iMac" value="{{$user->name}}">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="email" id="email" name="email"
                                       ...
                                       placeholder="abc@xyz.com" value="{{$user->email}}">
                                @if($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                            ...
                            <div class="form-group mb-3">
                                <label for="password">{{--__('admin.password')--}}Contraseña</label>
