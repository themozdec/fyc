...
<html lang="en">
<head>
    @include('admin.layouts.shared.title-meta', ['title' => "Restablecer Contraseña"])
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card bg-pattern">
                    <div class="card-body p-4">
                        <div class="text-center w-75 m-auto">
                            ...
                            <p class="text-muted mb-4 mt-3">Restablece tu contraseña</p>
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-12 text-center">
                        ...
                        <p class="text-white-50">¿No tienes una cuenta? <a class="text-white ml-1"><b>Registrarse</b></a></p>
                    </div> <!-- end col -->
                </div>
                <!-- end row -->
