...
class UserAddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($address->save()) {
            return response(['message' => 'Dirección agregada'], 200);
        }
    ...
    public function update(Request $request,$address_id)
    {
        ...
        if(isset($request->default)){
            ...
            if($userAddress->save()){
                return response(['message'=>['Tu dirección ha sido cambiada']]);
            }else{
                return response(['errors'=>['Algo salió mal']],402);
            }
        }
        ...
        return response(['message'=>['Tu dirección ha sido cambiada']],402);
    }
    ...
    public function destroy($id){
        ...
        if($userAddress->delete()){
            return response(['message' => 'Tu dirección ha sido eliminada'], 200);
        }else{
            return response(['errors' => ['Algo salió mal']], 403);
        }
