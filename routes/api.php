...
Route::group(['prefix' => 'v1/user'], function () {
    ...
    Route::group(['middleware' => ['auth:user-api']], function () {
        ...
        Route::post('/users', 'Api\v1\User\UserController@store');
        Route::get('/users/{id}', 'Api\v1\User\UserController@show'); 
        Route::post('/users/{id}', 'Api\v1\User\UserController@update');
        Route::delete('/users/{id}', 'Api\v1\User\UserController@destroy');

        //----------------- Products ------------------------------//
        Route::get('/products', 'Api\v1\User\ProductController@index');
        Route::post('/products', 'Api\v1\User\ProductController@store');
        Route::post('/products/{id}', 'Api\v1\User\ProductController@update');
        Route::delete('/products/{id}', 'Api\v1\User\ProductController@destroy');
        ...
        Route::get('/addresses/{id}', 'Api\v1\User\UserAddressController@show');
        ...
        Route::delete('/favorites/{id}', 'Api\v1\User\FavoriteController@destroy');
    ...
    Route::get('/maintenance', function () {
        return response(['message' => ['FYC is now online']], 200);
    });
